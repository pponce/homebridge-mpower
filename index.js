...
mPowerAccessory.prototype.setState = function(state, callback) {
  ...
  var cmdUpdate = 'echo $(ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 ubnt@' + this.url + ' "echo ' + state + ' > /proc/power/relay' + this.id + ';cd /proc/power;grep \'\' relay' + this.id + '*;exit;")';
...
mPowerAccessory.prototype.getState = function(callback) {
  ...
  var cmdStatus = 'echo $(ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 ubnt@' + this.url + ' "cd /proc/power;grep \'\' relay' + this.id + '*;exit;")';
...
mPowerAccessory.prototype.getOutletInUse = function(callback) {
  ...
  var cmdOutletInUseStatus = 'echo $(ssh -oKexAlgorithms=+diffie-hellman-group1-sha1 ubnt@' + this.url + ' "cd /proc/power;grep \'\' active_pwr' + this.id + '*;exit;")';
